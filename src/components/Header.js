...
export default function Header({ pageBanner }) {
  ...
  return (
    <div className="z-20 bg-slate-50 flex justify-between items-center py-2 px-10">
      <div className="justify-self-start flex gap-10">
        <Link href='/'>
          <img src="/images/Bellspace-logo.jpeg" alt="Logo" className="max-w-[10vw] max-h-min" />
        </Link>
        <PageBanner />
      </div>
